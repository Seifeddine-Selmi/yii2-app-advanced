                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?= Url::base(true)?>/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?= Url::base(true)?>/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
...
/*
  ...
  */
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <?php if (Yii::$app->user->can('admin')) { ?>
                            ...
                            <li class="active">
                                <a href="<?php echo Url::to(['/admin/assignment']) ?>"><i class="fa fa-circle-o"></i>Assignments</a>
                            </li>
                            <li>
                                <a href="<?php echo Url::to(['/admin/role']) ?>"><i class="fa fa-circle-o"></i>Roles</a>
                            </li>
                            <li>
                                <a href="<?php echo Url::to(['/admin/permission']) ?>"><i class="fa fa-circle-o"></i>Permessions</a>
                            </li>
                            <li>
                                <a href="<?php echo Url::to(['/admin/rule']) ?>"><i class="fa fa-circle-o"></i>Rules</a>
                            </li>
                            <li>
                                <a href="<?php echo Url::to(['/user']) ?>"><i class="fa fa-circle-o"></i>Users</a>
                            </li>
                        <?php } ?>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; My Company <?= date('Y') ?><strong>
    </footer>
